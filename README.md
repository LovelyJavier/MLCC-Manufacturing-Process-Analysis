...
| **How do defect patterns and priority areas change across product size, capacitance rating, process, production shift, and defect category?** | <img src="Graph/D2_Q4.png" width="700"> | **General idea:**<br><br>Interactive filtering showed that defect distributions and manufacturing priorities can be evaluated under specific product and operating conditions. This enables broad quality-loss patterns to be narrowed to particular product sizes, capacitance ratings, processes, shifts, and defect categories for more targeted root-cause investigation.<br><br>**Interactive Analysis; Drill-down example:**<br><br>Under the selected conditions, **52 defective lots** were identified, with defects concentrated entirely in **Tape Casting**. The defect pattern was almost evenly divided between **High ESR (27 lots)** and **Low IR (25 lots)**. Machine-level analysis further showed defects distributed across **TC01 and TC02**, providing a narrower scope for subsequent root-cause investigation. |
